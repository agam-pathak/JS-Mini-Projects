...
- **Styling:** Vanilla CSS (Glassmorphism, Neon Aesthetics, Responsive Design)
- **Features:** LocalStorage for scores, Fetch API for weather/currency, Canvas API for games.
